...
$senha_cripto = md5('123');
if (@count($dados) == 0) {
   $res = $pdo->query("INSERT into usuarios (nome, cpf, email, senha, senha_cripto, nivel) values ('Administrador', '000.000.000-00', '$email', '123', '$senha_cripto', 'owner')");
}
            ...
            <div id="first">
               <div class="myform form ">
                  <div class="d-flex align-items-center justify-content-center my-4">
                     <img src="../img/logotipo/logo-principal.png" alt="logotipo" class="rounded-circle" width="120">
                  </div>
                  <div class="logo mb-3">
                  ...
                  <form action="autenticar.php" method="post" name="login">
                     <div class="form-group">
                        ...
                        <input type="text" name="email_login" class="form-control" id="email_login" aria-describedby="emailHelp" placeholder="Insira seu Email">
                     </div>
                     <div class="form-group">
