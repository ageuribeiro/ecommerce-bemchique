...
<div class="table-responsive small">
    <table class="table table-striped table-sm" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            <?php
            $query = $pdo->query("SELECT * FROM promocoes order by id desc ");
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <a href="index.php?pag=<?php echo $pag ?>&funcao=editar&id=<?php echo $id ?>" class='btn-bc-primary mr-1' title='Editar Promoções'><i class='bx bxs-edit icon'></i></a>
                        <a href="index.php?pag=<?php echo $pag ?>&funcao=excluir&id=<?php echo $id ?>" class='btn-bc-danger mr-1' title='Excluir Promoções'><i class='bx bx-trash icon'></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
